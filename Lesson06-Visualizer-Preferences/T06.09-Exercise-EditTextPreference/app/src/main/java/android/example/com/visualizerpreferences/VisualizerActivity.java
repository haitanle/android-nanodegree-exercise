...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadMeasureFromPreferences(sharedPreferences);
    ...
    private void loadMeasureFromPreferences(SharedPreferences sharedPreferences){
        Float measure = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_edit_measure_key),
                getString(R.string.pref_edit_measure_default)));
        mVisualizerView.setMinSizeScale(measure);
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            loadColorFromPreferences(sharedPreferences);
        } else if (key.equals(getString(R.string.pref_edit_measure_key))) {
            loadMeasureFromPreferences(sharedPreferences);
        }
    }
