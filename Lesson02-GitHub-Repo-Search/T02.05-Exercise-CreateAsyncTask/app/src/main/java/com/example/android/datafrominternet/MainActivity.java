...
//        }
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... urls){
            ...
            try {
                searchQueryResult = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e){
                e.printStackTrace();
            }
        ...
        @Override
        protected void onPostExecute(String searchQueryResult){
            if (searchQueryResult != null && !searchQueryResult.equals("")){
                mSearchResultsTextView.setText(searchQueryResult);
            }
        }
    }
