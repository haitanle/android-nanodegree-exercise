...
public class NotificationUtils {
    ...
    //unique for pending intent increment water
    private static final int INCREMENT_PENDING_INTENT_ID = 227;

    //unique for pending intent ignore notification
    private static final int IGNORE_PENDING_INTENT_ID = 107;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        //      donoe (9) Create an Action for the user to ignore the notification (and dismiss it)
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification, "Yes, I have.", pendingIntent);
