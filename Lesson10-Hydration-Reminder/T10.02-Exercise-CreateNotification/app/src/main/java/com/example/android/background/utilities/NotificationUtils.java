...
public class NotificationUtils {
    ...
    //this is to uniquely identify the pending intent
    private static final int PENDING_INTENT_ID = 227;

    //a uniquely identify number for notification for update or delete
